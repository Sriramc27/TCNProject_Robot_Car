...
// void ApplicationFunctionSet::ApplicationFunctionSet_back(void)
// {
//   ApplicationFunctionSet_SmartRobotCarMotionControl(Backward, 100);
// }

// void ApplicationFunctionSet::ApplicationFunctionSet_forward(void)
// {
//   //ApplicationFunctionSet_SmartRobotCarMotionControl(Forward, 100);
...
void ApplicationFunctionSet::ApplicationFunctionSet_ObsAvoid(void)
{
    Application_SmartRobotCarxxx0.Functional_Mode = ObstacleAvoidance_mode;
}

void ApplicationFunctionSet::ApplicationFunctionSet_Obsstop(void)
{
  Application_SmartRobotCarxxx0.Functional_Mode = Standby_mode;
}

// void ApplicationFunctionSet::ApplicationFunctionSet_stop(void)
// {
