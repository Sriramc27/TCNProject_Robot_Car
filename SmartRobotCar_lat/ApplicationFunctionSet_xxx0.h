...
public:
  ...
  void ApplicationFunctionSet_back(void);
  void ApplicationFunctionSet_forward(void);
  void ApplicationFunctionSet_ObsAvoid(void);
  void ApplicationFunctionSet_Obsstop(void);
  void ApplicationFunctionSet_stop(void);
