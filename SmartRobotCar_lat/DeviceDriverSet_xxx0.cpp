                                                          ...
                                                          )                                     //Motor control
{
  ...
  if (controlED == control_enable) //Enable motot control？
  {
    ...
    { //A...Right
      ...
      {
      case direction_just:
        //Serial.print("direction_just");
        digitalWrite(PIN_Motor_AIN_1, HIGH);
        analogWrite(PIN_Motor_PWMA, speed_A);
        break;
      case direction_back:
        //Serial.print("direction_back");
        digitalWrite(PIN_Motor_AIN_1, LOW);
        analogWrite(PIN_Motor_PWMA, speed_A);
        break;
      case direction_void:
        //Serial.print("direction_void");
        analogWrite(PIN_Motor_PWMA, 0);
        digitalWrite(PIN_Motor_STBY, LOW);
        break;
      default:
        //Serial.print("direction_default");
        analogWrite(PIN_Motor_PWMA, 0);
        digitalWrite(PIN_Motor_STBY, LOW);
        break;
      }
...
// void DeviceDriverSet_Motor::DeviceDriverSet_Motor_back(void)
// {
//   digitalWrite(PIN_Motor_AIN_1, HIGH);
...
// void DeviceDriverSet_Motor::DeviceDriverSet_Motor_forward(void)
// {
//   digitalWrite(PIN_Motor_AIN_1, LOW);
//   analogWrite(PIN_Motor_PWMA, 200);
//   digitalWrite(PIN_Motor_BIN_1, HIGH);
...
// void DeviceDriverSet_Motor::DeviceDriverSet_Motor_left(void)
// {
//     digitalWrite(PIN_Motor_AIN_1, LOW);
//     analogWrite(PIN_Motor_PWMA, 200);
//     digitalWrite(PIN_Motor_BIN_1, LOW);
...
// void DeviceDriverSet_Motor::DeviceDriverSet_Motor_right(void)
// {
//     digitalWrite(PIN_Motor_AIN_1, HIGH);
//     analogWrite(PIN_Motor_PWMA, 200);
//     digitalWrite(PIN_Motor_BIN_1, HIGH);
...
// void DeviceDriverSet_Motor::DeviceDriverSet_Motor_stop(void)
// {
//     digitalWrite(PIN_Motor_AIN_1, LOW);
//     analogWrite(PIN_Motor_PWMA, 0);
//     digitalWrite(PIN_Motor_BIN_1, HIGH);
