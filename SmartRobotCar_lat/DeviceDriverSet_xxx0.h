...
public:
  ...
  void DeviceDriverSet_Motor_back(void);      
  void DeviceDriverSet_Motor_forward(void);    
  void DeviceDriverSet_Motor_left(void);    
  void DeviceDriverSet_Motor_right(void);    
  void DeviceDriverSet_Motor_stop(void);                                                              //motor control
private:
